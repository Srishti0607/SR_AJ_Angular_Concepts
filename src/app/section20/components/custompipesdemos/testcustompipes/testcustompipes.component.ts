...
@Component({
  selector: 'app-testcustompipes',
  templateUrl: './testcustompipes.component.html',
  styleUrls: ['./testcustompipes.component.css']
})
export class TestcustompipesComponent {

  products!: any[];
  username: string = "Kameswara Sarma";
